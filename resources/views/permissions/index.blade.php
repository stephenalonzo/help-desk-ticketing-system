...
<div class="relative overflow-x-auto w-2/3">
    <div class="bg-white rounded-md border border-gray-300">
        <div class="bg-gray-100 p-3 rounded-t-md">{{ Route::current()->getName() == 'permissions.index' ? 'Manage Permissions' : '' }}</div>
        <div class="p-4">
                ...
                <tbody>
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap flex flex-row items-center space-x-4 dark:text-white">
                            <a href="{{ route('permissions.edit', $permission->id) }}" class="rounded-md px-4 py-2 bg-green-700 text-white">Edit</a>
                            <form action="{{ route('permissions.destroy', $permission->id) }}" method="post" class="m-0 p-0">
                                @csrf
                                @method('DELETE')
