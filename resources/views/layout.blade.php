                   ...
                   <ul class="space-y-2 font-medium">
                      ...
                      <li>
                        ...
                        <ul id="dropdown-tickets" class="hidden py-2 space-y-2">
                              ...
                              <li>
                                 <a href="{{ route('tickets.index') }}" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Logs</a>
                              </li>
                              @endrole
                              @role('agent')
                              <li>
