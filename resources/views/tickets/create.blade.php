...
<div class="bg-white border border-gray-400 rounded-md">
    ...
    <div class="p-4">
        <form action="{{ route('ticket.store') }}" method="post" class="w-full mx-auto grid grid-flow-row gap-6">
            @csrf
            <div class="flex flex-col justify-between w-full">
                {{-- <label for="" class="font-semibold">Your Name</label> --}}
                <input type="text" name="author" id="" class="rounded-md border border-gray-400">
            </div>
            <div class="flex flex-col justify-between w-full">
                {{-- <label for="" class="font-semibold">Your Email</label> --}}
                <input type="email" name="author_email" id="" class="rounded-md border border-gray-400">
            </div>
            <div class="flex flex-col justify-between w-full">
