...
<div class="relative overflow-x-auto">
    <div class="bg-white rounded-md border border-gray-300">
        <div class="bg-gray-100 p-3 rounded-t-md">{{ Route::current()->getName() == 'tickets.index' ? 'Manage Tickets' : '' }}</div>
        <div class="p-4 space-y-4">
            <div class="flex flex-row items-center justify-end">
                <form action="/tickets" method="get" class="relative">
                    ...
                    <input type="text" name="search" id="" class="pl-9 rounded-md border border-gray-300 focus:outline-none focus:ring-0 focus:border-gray-200" placeholder="Search">
                </form>
            </div>
